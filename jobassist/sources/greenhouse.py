"""Greenhouse ATS fetcher — uses the public embed JSON endpoint, no LLM."""
...
def _to_posting(job: dict[str, Any], company: str) -> JobPosting:
    return JobPosting(
        ...
        source="greenhouse",
        posted_date=_parse_date(job.get("updated_at", "")),
...
class GreenhouseFetcher:
    """Fetches postings from Greenhouse public board endpoints."""
