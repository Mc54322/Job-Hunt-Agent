"""Remote cache client for web_scraper.

The LLM response cache lives in the job_recommender service. web_scraper reaches it
over HTTP (`POST /cache/get|set`). Caching is a best-effort optimisation: if the
cache service is unreachable, calls degrade to a miss rather than failing the request.
"""
